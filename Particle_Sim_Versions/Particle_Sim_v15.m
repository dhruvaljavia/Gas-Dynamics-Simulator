...
% Particle A
massPart_A = 5; % mass of particles [amu OR gm/mol]
nPart_A = 20; % no. of particles
size_A = 5; % particle diameter [angstrom]
...
speed_B = 0.0063; % [angstrom/femtosecond]

% Environment and post-processing settings
g = 9.8; % acceleration due to gravity (delta_V/timeStep) [m/s2]
heatIn = 0.5; % in units of energy/time [W]
