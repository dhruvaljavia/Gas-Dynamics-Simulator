...
% Particle A
massPart_A = 16; % mass of particles [amu OR gm/mol]
nPart_A = 10; % no. of particles
size_A = 1.28; % particle diameter [angstrom]
speed_A = 0.0056; % initial speed [angstrom/femtosecond]

% Particle B
massPart_B = 16; % [amu OR gm/mol]
nPart_B = 1000;
size_B = 2*0.64; % [angstrom]
speed_B = 0.0056; % [angstrom/femtosecond]

% Environment and post-processing settings
g = 9.8; % acceleration due to gravity (delta_V/timeStep) [m/s2]
heatIn = 0.000005; % in units of energy/time [W]
criticalEnergy = 1; % Minimum total K.E. of two atoms along line-of-centre for reaction to happen [kcal/mol]
box_xmax = 100; % max box width [angstrom]
box_ymax = 100; % max box breadth [angstrom]
timeTotal = 100000; % [femtoseconds]
timeStep = 100; % dicretized time [femtoseconds]
